...
template.innerHTML = `
    ...
    <button class="button-backward">
        <svg id="backward-button-img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <div class="companion">
        <div class="companion-image">
            <svg version="1.1" id="companion_logo" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <button class="button-search">
        <svg id="search-button-img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <button class="button-settings">
        <svg id="settings-button-img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
