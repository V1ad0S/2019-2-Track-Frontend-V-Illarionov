...
template.innerHTML = `
  ...
  <input type="text">
  <button class="attach-button"><svg id="attach-button-img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
...
c-56.1,0-102,45.9-102,102c0,56.1,45.9,102,102,102H382.5v38.25H140.25z"/>
  ...
  <button type="submit" class="submit-button"><svg id="submit-button-img" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
